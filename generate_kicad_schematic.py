...
part("Device:L", "L2", "XAL7070-682MEC 6.8uH", 110, 68, "Inductor_SMD:L_Coilcraft_XAL7070-XXX")
two_pin("L2", "PI_BUCK_SW", "PI_5V_RAW")
part("Device:C", "C32", "2.2uF 25V X7R", 36, 65, "Capacitor_SMD:C_0805_2012Metric")
two_pin("C32", "VBAT_SW", "GND")
part("Device:C", "C33", "2.2uF 25V X7R", 47, 65, "Capacitor_SMD:C_0805_2012Metric")
two_pin("C33", "VBAT_SW", "GND")
part("Device:C", "C34", "2.2uF 25V X7R", 36, 76, "Capacitor_SMD:C_0805_2012Metric")
two_pin("C34", "VBAT_SW", "GND")
part("Device:C", "C35", "2.2uF 25V X7R", 47, 76, "Capacitor_SMD:C_0805_2012Metric")
...
part("Device:C_Polarized", "C38", "220uF 10V LOW ESR", 148, 57, "Capacitor_THT:CP_Radial_D8.0mm_P3.50mm")
two_pin("C38", "PI_5V_RAW", "GND")
part("Device:C_Polarized", "C39", "220uF 10V LOW ESR", 158, 57, "Capacitor_THT:CP_Radial_D8.0mm_P3.50mm")
two_pin("C39", "PI_5V_RAW", "GND")
part("Device:C", "C44", "1uF 10V X7R", 168, 57, "Capacitor_SMD:C_0805_2012Metric")
...
part("Device:L", "L3", "XAL7070-682MEC 6.8uH", 313, 57, "Inductor_SMD:L_Coilcraft_XAL7070-XXX")
two_pin("L3", "SERVO_BUCK_SW", "SERVO_6V_RAW")
part("Device:C", "C46", "2.2uF 25V X7R", 248, 55, "Capacitor_SMD:C_0805_2012Metric")
two_pin("C46", "VBAT_SW", "GND")
part("Device:C", "C47", "2.2uF 25V X7R", 258, 55, "Capacitor_SMD:C_0805_2012Metric")
...
part("Device:C_Polarized", "C50", "220uF 10V LOW ESR", 364, 48, "Capacitor_THT:CP_Radial_D8.0mm_P3.50mm")
two_pin("C50", "SERVO_6V_RAW", "GND")
part("Device:C", "C51", "1uF 10V X7R", 374, 48, "Capacitor_SMD:C_0805_2012Metric")
...
two_pin("C42", "3V3", "GND")
part("Device:C", "C43", "10uF 10V X7R", 322, 208, "Capacitor_SMD:C_0805_2012Metric")
two_pin("C43", "3V3", "GND")
